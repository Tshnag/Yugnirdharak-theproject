...
<?php
  ...
  if (isset($_POST['reg_user'])) {
    ...
    // register user if there are no errors in the form
      ...
      $query = "INSERT INTO `students`.`users` (`username`, `password`, `role`,`email`) 
          ...
          <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1 align="center">YugNirdharak Learning System</h1>
                        <div class="description">
                          <p align="center">
                            This web based learning system framework will allow instructors to create any YugNirdharak learning program.
                          </p>
                        </div>
                    </div>
                </div>s
