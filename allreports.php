...
if (isset($_GET['delete'])) {
    ...
    $delete_answers= "delete from students.answers where assessment_id=$delete_id;";;
    ...
    $delete_questions = "delete from students.questions where assessment_id=$delete_id;";
    ...
    $delete_assessments = "delete from students.assessments where id=$delete_id;";
	      ...
	      <li class="active"><i class="fa fa-folder-open"></i> All Quizzes</li>
            ...
            <div class="col-md-5">
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $query = "select  m.module_name, a.name, a.id_module, a.id  from students.modules m
                              join students.assessments a on m.id = a.id_module;";
